package lib.lookingGlass.com.xcompwiz.lookingglass.entity;
...
import lib.lookingGlass.com.xcompwiz.lookingglass.api.animator.CameraAnimatorPlayer;
...
public class EntityPortal extends Entity {
	...
	public EntityPortal(World world) {
		super(world);
		dataWatcher.addObject(targetID, 0);
	}
	...
	public IWorldView getActiveView() {
		...
		if (activeview == null) {
			activeview = ProxyWorldManager.createWorldView(getTarget(), null, 1600, 2400);
			if (activeview != null) {
